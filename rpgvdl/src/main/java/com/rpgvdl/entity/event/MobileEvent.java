...
import com.rpgvdl.entity.event.itf.IEventHelper;
import com.rpgvdl.entity.event.itf.IMobileEvent;
import com.rpgvdl.factory.gui.Coord;
...
public abstract class MobileEvent extends Event implements IMobileEvent {
    ...
    /* (non-Javadoc)
     * @see com.rpgvdl.entity.event.itf.IPerson#getFacedEvent()
     */
